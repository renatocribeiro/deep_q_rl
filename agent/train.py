...
def update_pool(env, pool, n_steps=100):
    ...
    env.load_sessions(observation_tensor/128., action_tensor, reward_tensor,
                      is_alive_tensor, preceding_memory_states)  # max_pool_size=1e5)
...
batch_size = 64  # TODO: make a constant global
...
updates = lasagne.updates.adadelta(loss, weights, learning_rate=0.001)
